 ...
 * @since XXX
 */
class AureliaAsset extends AssetBundle
{
     ...
     */
    const CACHE_KEY = 'aurelia:bundles:';
     ...
     */
    public $css = [
        // '//fonts.googleapis.com/css2?family=Fira+Sans+Extra+Condensed:wght@500;700&family=Fira+Sans:ital,wght@0,300;0,400;0,500;1,300;1,400&display=swap'
    ];
